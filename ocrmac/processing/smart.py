...
from ..analysis import ImageAnalyzer, ImageProfile, LayoutAnalyzer
from ..postprocessing import TextCleaner
from .adaptive import AdaptiveOCR, OCROutput
...
class SmartOCR:
    ...
    def _apply_layout(self, results: List) -> str:
        """应用布局分析"""
        from ..analysis.layout import format_with_layout
